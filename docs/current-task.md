...
* 로그인 성공 시 실제 인증 상태 저장이나 권한 처리는 하지 않고, 로그인 성공 알림창을 한 번 표시한다.
...
* 관련 요구사항:
  ...
  * 로그인 성공 시 MVP 임시 처리로 로그인 성공 알림창을 한 번 표시한다.
...
* [ ] 성공 응답 수신 시 로그인 성공 알림창이 한 번 표시된다.
